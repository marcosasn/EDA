...
public class MyMinHeapTest {
	private MyMinHeap<Integer> heap1;
	private MyMinHeap<Integer> heap2;
	private MyMinHeap<Integer> heap3;

	@Before
	public void setUp() throws Exception {
		heap1 = new MyMinHeap<Integer>();
		heap2 = new MyMinHeap<Integer>();
		heap3 = new MyMinHeap<Integer>();
	}
