...
public class MaxHeapImplTest {
	...
	private MaxHeapImpl<Integer> heap1;
	private MaxHeapImpl<Integer> heap2;
	private MaxHeapImpl<Integer> heap3;

	@Before
	public void setUp() throws Exception {
		heap1 = new MaxHeapImpl<Integer>();
		heap2 = new MaxHeapImpl<Integer>();
		heap3 = new MaxHeapImpl<Integer>();
	}
	...
	public void testExtractRooTElement() {
		...
		assertEquals(new Integer(40), heap1.extractRootElement());
		assertEquals(new Integer(36), heap1.rootElement());
		...
		assertEquals(new Integer(16), heap2.extractRootElement());
		assertEquals(new Integer(14), heap2.rootElement());
	}
